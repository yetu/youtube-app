...
describe('Directive: ui-video-list', function () {
    ...
    var mockDummyService = function () {
        var getNext = function (arg1, arg2) {
            return true;
        };
        return {
            getNext: getNext
    ...
    beforeEach(module('youtubeApp', function($provide){
        $provide.service('dummyService', mockDummyService);
    }));
    ...
    it('should log error on play link if defined but doesnt exist', function () {
        var element = $compile('<ui-video-list ng-model="videos" play-fn="someFunction" service="dummyService"></ui-video-list>')($rootScope);
        $rootScope.videos = { etag: "123", next: "123", items:
            [
                {id: 'id123', title: 'Some title', type: 'video', img: 'some.img', description: 'Some description'}
            ]};
